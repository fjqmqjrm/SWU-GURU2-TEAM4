...
class MyPageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        updateMedalImage(checkedPart)  // 메달 이미지 업데이트
    ...
    private fun showPage(isOwner: Boolean) {
        ...
        if(part1Checkbox.isChecked){
            medal.setImageResource(R.drawable.part1)
        } else if(part2Checkbox.isChecked){
            medal.setImageResource(R.drawable.part2)
        } else if(part3Checkbox.isChecked){
            medal.setImageResource(R.drawable.part3)}
        else{
            medal.setImageResource(R.drawable.part4)
        }
