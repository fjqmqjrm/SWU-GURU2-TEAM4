...
class DBHelper(context: Context) :
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        MyDB!!.execSQL("CREATE TABLE PartPage(partName TEXT PRIMARY KEY, url TEXT, user_id TEXT, FOREIGN KEY(user_id) REFERENCES users(id))")
  ...
  fun getUserNicknameById(id: String): String? {
   ...
   fun getCommentsByPostId(postId: String): List<Comment> {
    ...
    fun insertPartUrl(userId: String, partName: String?, url: String?): Boolean {
        val MyDB = this.writableDatabase
    ...
    @SuppressLint("Range")
    fun getPartUrl(userId: String, partName: String): String? {
        val MyDB = this.readableDatabase
        val cursor = MyDB.rawQuery("SELECT url FROM PartPage WHERE partName = ? AND user_id = ?", arrayOf(partName, userId))
